...
const phoneNumberIdField = (resources, operations) => ({
...
const phoneNumberField = (resources, operations, description = 'Subscriber phone number with country code (no + sign)') => ({
...
exports.fields = [
    ...
    phoneNumberIdField(['subscriber'], ['get', 'delete', 'resetFlow', 'assignTeam', 'assignCustomFields',
        'assignLabels', 'removeLabels', 'assignSequences', 'removeSequences', 'addNote', 'update']),
    phoneNumberField(['subscriber'], ['get', 'delete', 'resetFlow', 'assignTeam', 'assignCustomFields',
        'assignLabels', 'removeLabels', 'assignSequences', 'removeSequences', 'addNote', 'update']),
    // ── SUBSCRIBER: List ──────────────────────────────────────────────────────
